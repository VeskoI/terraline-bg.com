angular.module('app').controller('industrialniPodoveController', ['$scope', '$rootScope', '$location', '$route', '$routeParams', function ($scope, $rootScope, $location, $route, $routeParams) {
    ...
    $scope.thickness = [
        ...
        {
            key: 'Средна',
            value: 'Интензивен пешеходен трафик с устойчивост на мебели с колелца, както и умерен трафик на палетни колички и леки автомобили – в натоварени обществени зони и леки производства'
        },
        {
            key: 'Висока',
            value: 'Усилен трафик на палетни колички и трафик на кари, както и интензивен трафик на леки автомобили – в складове, производства, свръхнатоварени обществени зони и други'
        },
        {
            key: 'Екстремна',
            value: 'Трафик на тежкотоварни автомобили и подемна техника – рампи, тежки производства и други'
        }
